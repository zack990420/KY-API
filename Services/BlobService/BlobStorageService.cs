...
public class BlobStorageService : IBlobStorageService
{
    ...
    public BlobStorageService(IConfiguration configuration, IBlobRepository blobRepository)
    {
        ...
        {
            throw new ArgumentNullException("AzureStorage:ConnectionString", "Azure Storage Connection String is missing in configuration.");
        }
        _blobServiceClient = new BlobServiceClient(connectionString);
    }

    public async Task<string> UploadAsync(string folderName, BlobContentType contentType, string fileName, Stream content, BlobType blobType, long userId)
    {
